...
class TestCalculator(unittest.TestCase):
    ...
    def test_nth_root(self):
        ...
        self.assertAlmostEqual(self.calculator.nth_root(4, 3), 1.5874010519681994)

    def test_nth_root_negative(self):
        self.assertAlmostEqual(self.calculator.nth_root(-2, 3), (0.6299605249474367+1.0911236359717214j))

    def test_nth_root_float(self):
        self.assertAlmostEqual(self.calculator.nth_root(2.5, 5), 1.2011244339814313)
        self.assertAlmostEqual(self.calculator.nth_root(2, 5.1), 1.1455801751628705)
        self.assertAlmostEqual(self.calculator.nth_root(2.5, 5.1), 1.1968161822205403)
