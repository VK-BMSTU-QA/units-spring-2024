...
class TestCalculator(unittest.TestCase):
    ...
    def test_add_infinity(self):
        self.assertEqual(math.inf, self.calculator.subtraction(math.inf, 1))
    ...
    def test_log_inf(self):
        self.assertEqual(self.calculator.log(10, math.inf), 0)
    ...
    def test_nth_inf(self):
        self.assertEqual(self.calculator.nth_root(12, math.inf), 1)
